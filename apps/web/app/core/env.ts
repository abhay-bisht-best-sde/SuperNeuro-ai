...
const envSchema = z.object({
  ...
  // LangSmith (OpenAI/LLM tracing dashboard - smith.langchain.com)
  ...
  COMPOSIO_AUTH_CONFIG_GOOGLECALENDAR: z.string().optional(),
  COMPOSIO_AUTH_CONFIG_GOOGLEDRIVE: z.string().optional(),
  COMPOSIO_AUTH_CONFIG_GOOGLESHEETS: z.string().optional(),
  COMPOSIO_AUTH_CONFIG_GOOGLEDOCS: z.string().optional(),
  ...
  COMPOSIO_AUTH_CONFIG_TAVILY: z.string().optional(),
  COMPOSIO_AUTH_CONFIG_FIRECRAWL: z.string().optional(),
...
function loadEnv(): Env {
  const parsed = envSchema.safeParse({
    ...
    COMPOSIO_AUTH_CONFIG_GOOGLECALENDAR: process.env.COMPOSIO_AUTH_CONFIG_GOOGLECALENDAR,
    COMPOSIO_AUTH_CONFIG_GOOGLEDRIVE: process.env.COMPOSIO_AUTH_CONFIG_GOOGLEDRIVE,
    COMPOSIO_AUTH_CONFIG_GOOGLESHEETS: process.env.COMPOSIO_AUTH_CONFIG_GOOGLESHEETS,
    COMPOSIO_AUTH_CONFIG_GOOGLEDOCS: process.env.COMPOSIO_AUTH_CONFIG_GOOGLEDOCS,
    ...
    COMPOSIO_AUTH_CONFIG_TAVILY: process.env.COMPOSIO_AUTH_CONFIG_TAVILY,
    COMPOSIO_AUTH_CONFIG_FIRECRAWL: process.env.COMPOSIO_AUTH_CONFIG_FIRECRAWL,
